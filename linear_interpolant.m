...
base_dir = '/Users/hridaytalreja/Desktop/Jan_data_2026/2026_01_14_F6_test_mat/SMS_2026_0114_1636_1/Pos0/';
...
pivMatFile = '/Users/hridaytalreja/Desktop/Jan_data_2026/2026_01_14_F6_test_mat/PIVlab.mat';
...
for fr = 1:nFrames
    ...
    radius_of_mask_px(fr) = areaMask(fr) * (1/3.125);
    ...
    if mod(fr, saveEveryN_QC) == 1
        ...
        quiver(poly(subsamp,1), poly(subsamp,2), tx(subsamp)*20, ty(subsamp)*2, 0, 'g', 'LineWidth', 1);
...
ylabel('Time (min)', 'FontSize', 12);
title('Tangential Cortical Flow v_\theta(\theta,t)', 'FontSize', 14);
colormap(gca, 'parula');
cb = colorbar;
...
if makeEnhancedKymographs
    ...
    xlabel('Angular Bin Number', 'FontSize', 12);
    ylabel('Time (min)', 'FontSize', 12);
    title('Tangential Flow Magnitude |v_\theta|', 'FontSize', 14);
    colormap(gca, 'hot');
    cb = colorbar;
    ylabel(cb, '|v_\theta| (nm/s)', 'FontSize', 11);
    ...
    xlabel('Angular Bin Number', 'FontSize', 12);
    ylabel('Time (min)', 'FontSize', 12);
    title('Tangential Flow Directionality', 'FontSize', 14);
    colormap(gca, redblue(256));
...
if makeSnapshotPlots
    ...
    for fr = 1:snapshotEveryNFrames:nFrames
        ...
        stats_text = {
            ...
            sprintf('Mask area: %.0f px^2', radius_of_mask_px(fr))
        };
